...
::: {style="text-align: center; margin-top: 50px; position: relative; height: 600px;"}
...
- We must graduate students who can prompt chatbots and who can evaluate and refine the work of chatbots.
- Replace "turn in an Excel workbook" with "turn in a chat, what was produced by the chat, and your evaluation of it."
...
:::: {.columns}
::: {.column width="70%"}
![](ai_learning_progression_with_prompt.png)
:::
...
- Apps can use AI
- Chatbots are apps
- Chatbot with tools is an agent
...
::: {.column width="20%"}
::: {style="font-size: 0.9em;"}
Response could be error message. Agent should send to LLM for new SQL code.
:::
:::
::::
