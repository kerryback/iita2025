...
![](ducks-sinking.png){style="max-height: 300pxpx; width: auto;"}
:::
:::
...
::: {style="text-align: center; margin-top: 50px; position: relative; height: 300pxpx;"}
::: {.fade-out data-fragment-index="1"}
![](coyote11.png){style="max-height: 300pxpx; width: auto;"}
:::

::: {.fragment .fade-in data-fragment-index="1" style="position: absolute; top: 0; left: 0; right: 0; margin-top: 0;"}
![](coyote21.png){style="max-height: 300pxpx; width: auto;"}
:::
:::
:::
...
:::: {.columns}
::: {.column width="60%"}
![](ai_learning_progression_with_prompt.png){style="max-height: 300pxpx; width: auto;"}
:::
...
::: {.column style="width: auto%; display: flex; align-items: center;"}
>for roughly a quarter of the startups in their Winter 2025 cohort, 95% of the codebase was written by AI.
:::
::: {.column style="width: auto%; display: flex; align-items: center; justify-content: center;"}
::: {.fragment}
![](bugs-bunny.png){style="max-height: 300pxpx; width: auto;"}
:::
:::
::::
...
![](chatbot.png){style="max-height: 300pxpx; width: auto;"}
...
:::: {.columns}
::: {.column width="60%"}
![](agent_v1.png){style="max-height: 300pxpx; width: auto;"}
:::
...
:::: {.columns}
::: {.column width="60%"}
![](agent_v2.png){style="max-height: 300pxpx; width: auto;"}
:::
::: {.column width="40%"}
:::
::::
...
:::: {.columns}
::: {.column width="60%"}
![](agent_v3.png){style="max-height: 300pxpx; width: auto;"}
:::
...
:::: {.columns}
::: {.column width="60%"}
![](agent_v4.png){style="max-height: 300pxpx; width: auto;"}
:::
::: {.column width="40%"}
:::
::::
