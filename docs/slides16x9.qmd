...
![](ducks-sinking.png){style="max-height: 720px; width: auto;"}
:::
:::
...
::: {style="text-align: center; margin-top: 50px; position: relative; height: 720px;"}
::: {.fade-out data-fragment-index="1"}
![](coyote11.png){style="max-height: 720px; width: auto;"}
:::

::: {.fragment .fade-in data-fragment-index="1" style="position: absolute; top: 0; left: 0; right: 0; margin-top: 0;"}
![](coyote21.png){style="max-height: 720px; width: auto;"}
:::
:::
:::
...
>Claude powered the first versions of our Investment Analyst Assistant, which <span class="highlight">streamlined our analysts' workflow by generating Python code</span>, creating data visualizations, and iterating through <span class="highlight">complex financial analysis tasks with the precision of a junior analyst</span>.
:::
...
- Get class to help build prompt to avoid errors, get better answer. Try new prompt, evaluate again, write a better one
...
:::: {.columns}
::: {.column width="70%"}
![](ai_learning_progression_with_prompt.png){style="max-height: 720px; width: auto;"}
:::
...
::: {.fragment}
![](bugs-bunny.png){style="max-height: 720px; width: auto;"}
:::
:::
::::
...
![](chatbot.png){style="max-height: 720px; width: auto;"}
...
:::: {.columns}
::: {.column width="70%"}
![](agent_v1.png){style="max-height: 720px; width: auto;"}
:::
...
:::: {.columns}
::: {.column width="70%"}
![](agent_v2.png){style="max-height: 720px; width: auto;"}
:::
::: {.column width="30%"}
:::
::::
...
:::: {.columns}
::: {.column width="70%"}
![](agent_v3.png){style="max-height: 720px; width: auto;"}
:::
...
:::: {.columns}
::: {.column width="70%"}
![](agent_v4.png){style="max-height: 720px; width: auto;"}
:::
::: {.column width="30%"}
:::
::::
