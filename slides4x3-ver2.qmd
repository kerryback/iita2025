...
3. Teaching about AI 
  - Prompt engineering
  - Vibe coding
4. Incorporating AI into teaching
...
1. Added courses teaching how to use them 
2. Revised existing courses to use them
...
- We're adding (and should add) courses in how to use it 
- Are we revising existing courses to use it?
- Can we assess how well students use it?
- Do we need to continue having assessments where AI is not allowed?
